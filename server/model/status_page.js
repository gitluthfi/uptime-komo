...
class StatusPage extends BeanModel {
    ...
    static async renderHTML(indexHTML, statusPage) {
        ...
        if (statusPage.icon) {
            // Strip a leading "/" so this resolves against the <base> tag injected
            // client-side, instead of always pointing at the site root.
            const iconHref = statusPage.icon.replace(/^\//, "");
            $("link[rel=icon]").attr("href", iconHref).removeAttr("type");
