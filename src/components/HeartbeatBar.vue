...
export default {
    ...
    methods: {
        ...
        drawCanvas() {
            ...
            // Read from document.body (not document.documentElement), since that's
            // where the "dark" class is toggled and dark-mode variants are overridden.
            ...
            const colors = {
                ...
                down: rootStyles.getPropertyValue("--bs-danger") || "#ef4444",
                pending: rootStyles.getPropertyValue("--bs-warning") || "#f59e0b",
                maintenance: rootStyles.getPropertyValue("--maintenance") || "#3b82f6",
                up: rootStyles.getPropertyValue("--bs-success") || "#22c55e",
            };
