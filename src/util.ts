...
export const appName = "Uptime Komo";
export const DOWN = 0;
export const UP = 1;
...
export const badgeConstants = {
    naColor: "#94A3B8",
    defaultUpColor: "#22C55E",
    defaultWarnColor: "#F59E0B",
    defaultDownColor: "#EF4444",
    defaultPendingColor: "#F59E0B",
    defaultMaintenanceColor: "#3B82F6",
